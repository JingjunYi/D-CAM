...
import torch
from tool.GenDataset import make_data_loader, make_data_loader_b2l
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.summary = TensorboardSummary(self.args.savepath)
        self.writer = self.summary.create_summary()
        kwargs = {'num_workers': args.workers, 'pin_memory': False}
        self.train_loader, self.val_loader, self.test_loader = make_data_loader_b2l(args, **kwargs)
        ...
        import importlib
        model_stage1 = getattr(importlib.import_module('network.resnet38_cls'), 'Net_CAM')(n_class=args.n_class)
    ...
    def validation(self, epoch):
        ...
        if mIoU > self.best_pred:
            ...
            }, 'stage2_checkpoint_trained_on_b2l.pth')
        if (epoch+1) % 2 == 0:
            self.saver.save_checkpoint({
                'state_dict': self.model.module.state_dict(),
                'optimizer': self.optimizer.state_dict()
            }, 'stage2_checkpoint_trained_on_b2l_e{}_{}.pth'.format(epoch, mIoU))
    def load_the_best_checkpoint(self):
        checkpoint = torch.load('{}/stage2_checkpoint_trained_on_b2l.pth'.format(self.args.savepath))
...
def main():
    ...
    parser.add_argument('--resume_stage1', type=str, default='checkpoints/stage1_checkpoint_trained_on_luad_lr0.005.pth')
