...
import torch
from tool.GenDataset import make_data_loader, make_data_loader_l2b
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader, self.val_loader, self.test_loader = make_data_loader_l2b(args, **kwargs)
    ...
    def validation(self, epoch):
        ...
        if mIoU > self.best_pred:
            ...
            }, 'stage2_checkpoint_trained_on_l2b.pth')
        if (epoch+1) % 2 == 0:
            self.saver.save_checkpoint({
                'state_dict': self.model.module.state_dict(),
                'optimizer': self.optimizer.state_dict()
            }, 'stage2_checkpoint_trained_on_l2b_e{}_{}.pth'.format(epoch, mIoU))
    def load_the_best_checkpoint(self):
        checkpoint = torch.load('{}/stage2_checkpoint_trained_on_l2b.pth'.format(self.args.savepath))
