    ...
    def path_label(self):
        ...
        for root, dirname, filename in os.walk(self.data_path):
            for f in filename:
                ...
                ##  LUAD-HistoSeg   : 'Image-name-of-BCSS'+'+index'+'[a b c d]'.png
                ##  BCSS-WSSS       : 'patient_ID'+'_x-axis'+'_y-axis'+'[abcd]'.png
                ##  WSSS4LUAD       : '436219-7159-48057-[a, b, c]'.png
                ##  Glas            : 'train_1_0-[a, b]'.png
                ...
                if self.dataset == 'luad':
                    ...
                    image_label = torch.Tensor([int(label_str[0]),int(label_str[3]),int(label_str[6])])
                elif self.dataset == 'dg':
...
class Stage2_Dataset_l2b(Dataset):
    def __init__(self, args, base_dir, split):
        ...
        if self.split   == "train":
            self._image_dir     = os.path.join(self._base_dir, 'train/')
            self._cat_dir       = os.path.join(self._base_dir, 'train_PM_l2b_ours/PM_bn7/')
            self._cat_dir_a     = os.path.join(self._base_dir, 'train_PM_l2b_ours/PM_b5_2')
            self._cat_dir_b     = os.path.join(self._base_dir, 'train_PM_l2b_ours/PM_b4_5')
        elif self.split == 'val':
            self._image_dir = os.path.join(self._base_dir, 'val/img/')
            self._cat_dir   = os.path.join(self._base_dir, 'val/mask/')
        elif self.split == 'test':
...
class Stage2_Dataset_b2l(Dataset):
    def __init__(self, args, base_dir, split):
        ...
        if self.split   == "train":
            self._image_dir     = os.path.join(self._base_dir, 'train/')
            self._cat_dir       = os.path.join(self._base_dir, 'train_PM_b2l_ours/PM_bn7/')
            self._cat_dir_a     = os.path.join(self._base_dir, 'train_PM_b2l_ours/PM_b5_2')
            self._cat_dir_b     = os.path.join(self._base_dir, 'train_PM_b2l_ours/PM_b4_5')
        elif self.split == 'val':
            self._image_dir = os.path.join(self._base_dir, 'val/img/')
            self._cat_dir   = os.path.join(self._base_dir, 'val/mask/')
        elif self.split == 'test':
...
def make_data_loader_l2b(args, **kwargs):
    
    train_set   = Stage2_Dataset_l2b(args, base_dir=args.dataroot, split='train')
    val_set     = Stage2_Dataset_l2b(args, base_dir=args.dataroot, split='val')
    test_set    = Stage2_Dataset_l2b(args, base_dir=args.dataroot, split='test')
...
def make_data_loader_b2l(args, **kwargs):
    
    train_set   = Stage2_Dataset_b2l(args, base_dir=args.dataroot, split='train')
    val_set     = Stage2_Dataset_b2l(args, base_dir=args.dataroot, split='val')
    test_set    = Stage2_Dataset_b2l(args, base_dir=args.dataroot, split='test')
